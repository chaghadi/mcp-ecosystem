"""migrations/env.py — Alembic migration environment for mcp-auth."""
...
def run_migrations_offline() -> None:
    ...
    context.configure(url=url, target_metadata=target_metadata, version_table="alembic_version_auth",
